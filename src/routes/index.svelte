    ...
    <header class="space-y-8 my-24">
        ...
        <div class="space-y-6">
            <p class="text-xl font-light tracking-wide leading-relaxed">
                ...
                <a href="https://www.apple.com/ios" target="_blank" class="text-red-600 font-medium bg-red-50 hover:bg-red-100 px-2 py-1 rounded-xl transition-colors dark:bg-red-800 dark:bg-opacity-20 dark:hover:bg-red-800 dark:hover:bg-opacity-30">iOS</a>,
                <a href="https://www.apple.com/macos" target="_blank" class="text-blue-600 font-medium bg-blue-50 hover:bg-blue-100 px-2 py-1 rounded-xl transition-colors dark:bg-blue-800 dark:bg-opacity-20 dark:hover:bg-blue-800 dark:hover:bg-opacity-30">macOS</a>,
                <a href="https://www.apple.com/tvos" target="_blank" class="text-gray-600 font-medium bg-gray-50 hover:bg-gray-100 px-2 py-1 rounded-xl transition-colors dark:bg-gray-100 dark:bg-opacity-10 dark:hover:bg-gray-100 dark:hover:bg-opacity-20 dark:text-gray-200">tvOS</a> and
        ...
        <ul class="flex space-x-6 pt-2">
            <li>
                <a href="https://github.com/lovetodream" target="_blank" class="ring-1 ring-gray-200 hover:bg-gray-50 dark:ring-gray-700 dark:bg-gray-800 dark:bg-opacity-30 dark:hover:bg-gray-800 dark:hover:bg-opacity-60 w-14 h-14 inline-flex items-center justify-center rounded-full transition-colors">
            ...
            <li>
                <a href="https://www.linkedin.com/in/timo-zacherl-8647531b6/" target="_blank" class="ring-1 ring-blue-200 hover:bg-blue-50 dark:ring-blue-800 dark:ring-opacity-60 dark:bg-blue-800 dark:bg-opacity-10 dark:hover:bg-blue-800 dark:hover:bg-opacity-20 w-14 h-14 inline-flex items-center justify-center rounded-full transition-colors">
            ...
            <li>
                <a href="mailto:timo@swiftbytimo.com" target="_blank" class="ring-1 ring-purple-200 hover:bg-purple-50 dark:ring-purple-800 dark:ring-opacity-60 dark:bg-purple-800 dark:bg-opacity-10 dark:hover:bg-purple-800 dark:hover:bg-opacity-20 w-14 h-14 inline-flex items-center justify-center rounded-full transition-colors">
...
<footer class="bg-gray-50 dark:bg-zinc-800 py-16 border-t dark:border-gray-600">
    <div class="container px-10 mx-auto max-w-screen-lg text-gray-500 dark:text-gray-100">
        <div class="flex flex-col md:flex-row text-center md:text-left space-y-4 justify-between">
